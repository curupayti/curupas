...
class _MainScreenState extends State<MainScreen> {
  ...
  @override
  void initState() {
    isRegistered().then((resultRegister) {
      if (resultRegister) {
  ...
  Future<bool> isGroupSaved() async {
    bool saved = await getGroupSaved();
    if (saved != null) {
      return true;
    } else {
      return false;
  ...
  Future<bool> getGroupSaved() async {
    prefs = await SharedPreferences.getInstance();
    bool groupSaved = prefs.getBool('group');
    return groupSaved;
  }
