...
class Streaming {
  ...
  final List<StreamingVideo> videos;
  ...
  factory Streaming.fromJson(Map<String, Object> doc, StreamingThumbnail thumbnail, List<StreamingVideo> videos) {
  ...
  factory Streaming.fromDocument(DocumentSnapshot doc, StreamingThumbnail thumbnail, List<StreamingVideo> videos) {
