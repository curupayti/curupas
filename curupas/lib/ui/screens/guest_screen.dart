...
class _GuestScreenState extends State<GuestScreen> {
  ...
  void initState() {
    ...
    getClubsList().then((val) => setState(() {
  ...
  void _guestLogin(LocationData _locationData, String phone) async {
    try {
      ...
      DocumentReference roleRef =
          await Auth.getRoleGroupReferenceByPath("roles/guest");
  ...
  Future<List<DropdownMenuItem<String>>> getClubsList() async {
    ...
    QuerySnapshot querySnapshot = await Cache.getCacheCollectionByPath("clubs");
